...
let blue = Color(hue: 224, saturation: 64, brightness: 100, alpha: 50)
let LimeGreen = Color(hue: 106, saturation: 64, brightness: 100, alpha: 100)
let Grey = Color(hue: 0, saturation: 0, brightness: 75, alpha: 100)
canvas.fillColor = LimeGreen
canvas.drawRectangle(at: Point(x: 0, y: 0), width: 400, height: 600)
canvas.textColor = Grey
canvas.drawText(message: "$136.00/Thursday", at: Point(x: 10, y: 585), size: 10, kerning: 1)
canvas.drawText(message: "August 9, 2018", at: Point(x: 10, y: 575), size: 10, kerning: 1)
...
canvas.drawText(message: "fifth studio album,", at: Point(x: 285, y: 585), size: 10, kerning: 1)
canvas.drawText(message: "KOD (2018)", at: Point(x: 285, y: 575), size: 10, kerning: 1)
canvas.drawText(message: "J.Cole", at: Point(x: 10, y: 405), size: 60, kerning: 1)
